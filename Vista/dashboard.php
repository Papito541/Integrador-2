...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> Pedidos por Usuario</div>
			<div class="panel-body">
				<table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">Órdenes por Usuario</th>
			  			<th style="width:20%;">Pedidos en S/</th>
			  		</tr>
			  	</thead>
			  	<tbody>
